...
class StructTurnLstmExpQLearning(Agent):
    ...
    def __init__(self, domain, representation, seed=1, epsilon=0.3, update_frequency=10,
        ...
        super(StructTurnLstmExpQLearning, self).__init__(domain, representation, seed)
        self.learning_policy = EpsilonGreedyPolicy(epsilon, seed)
        self.update_frequency = update_frequency

        self.experience = StructTurnExperience(exp_size=exp_size, usr_size=representation.state_features_num,
                                               sys_size= representation.sys_feature_num,
        ...
        self.behavior_representation = StructTurnHistoryRep(domain, seed=seed)

        # learner
        self.learner = StructTurnLstmDnnQ(domain=domain, representation=representation,
